...
//        Text text = new Text(context,cursor);
//
...
//            Text nextText = new Text(context,cursor);
//            cursor.moveToNext();
...
//            recipientLayout.getChildAt(0).getBackground().setColorFilter(ColorUtils.getColor(Long.parseLong(text.getThreadId())), PorterDuff.Mode.SRC_IN);
//
//            // Hide the user icon because there is already one showing on your first message in the cluster.
...
//            }
//            else {
//                userImage.setColorFilter(ColorUtils.getColor(Long.parseLong(text.getThreadId())));
//                textLetter.setText("");
//                if (sender.hasName()){
