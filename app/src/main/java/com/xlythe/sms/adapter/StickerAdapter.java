...
public class StickerAdapter extends RecyclerView.Adapter<StickerAdapter.ViewHolder> {
    ...
    private static final int[] STICKERS = {
            ...
            R.drawable.stickers_kill_me,
            R.drawable.stickers_lazyass,
            R.drawable.stickers_love,
            R.drawable.stickers_nicks_true_face,
            R.drawable.stickers_no_problem,
            R.drawable.stickers_pat,
            R.drawable.stickers_pets,
            R.drawable.stickers_pout,
            R.drawable.stickers_praise_me,
            R.drawable.stickers_puppydog_eyes,
            R.drawable.stickers_seans_true_face,
