...
//        }
        ...
        try {
            ...
            if (apnParameters != null) {
                sawValidApn = true;
                //String mmsc = apnParameters.getMmscUrl();
                mServiceCenter = apnParameters.getMmscUrl();
                mProxyAddress = apnParameters.getProxyAddress();
                if (isProxySet()) {
                    String portString = apnParameters.getProxyPort().toString();
                    try {
