...
package com.xlythe.textmanager.pdu;

import android.util.Log;

import com.xlythe.textmanager.help.Base64;
...
public class PduParser {
    ...
    public GenericPdu parse(){
        ...
        if (false == checkMandatoryHeader(mHeaders)) {
            Log.d(DEBUG_TAG,"check mandatory headers failed!");
            return null;
        }
            ...
            switch (headerField) {
                ...
                case PduHeaders.MESSAGE_SIZE:
                {
                    try {
                        ...
                        Log.d(DEBUG_TAG, headerField + "is not Long-Integer header field!");
                        return null;
                    }
                    break;
                }
                ...
                case PduHeaders.CONTENT_LOCATION:
                {
                    ...
                    if (null != value) {
                        try {
                            ...
                            Log.d(DEBUG_TAG, "null pointer error!");
                        } catch(RuntimeException e) {
                            Log.d(DEBUG_TAG, headerField + "is not Text-String header field!");
                            return null;
                        }
                    }
                    break;
                ...
                case PduHeaders.RESPONSE_TEXT:
                {
                    ...
                    if (null != value) {
                        try {
                            ...
                            Log.d(DEBUG_TAG, headerField + "is not Encoded-String-Value header field!");
                            return null;
                        }
                    }
                    break;
                ...
                case PduHeaders.PREVIOUSLY_SENT_BY: {
                    ...
                    try {
                        ...
                        Log.d(DEBUG_TAG, headerField + " is not Integer-Value");
                        return null;
                    }
                ...
                default: {
                    ...
                    Log.d(DEBUG_TAG,"Unknown header");
                }
            }
        }
        ...
        for (int i = 0 ; i < count ; i++) {
            ...
            if (dataLength > 0) {
                ...
                if (partContentType.equalsIgnoreCase(ContentType.MULTIPART_ALTERNATIVE)) {
                    ...
                    if (null == partData) {
                        Log.d(DEBUG_TAG,"Decode part data error!");
                        return null;
                    }
